...
import '../../../home/presentation/view/Booking_home_screen.dart';
...
class BookTicketsScreen extends StatefulWidget {
  ...
  const BookTicketsScreen({Key? key, required this.imageList, required this.movieName,required this.overview,required this.vote_average}) : super(key: key);
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BookingScreen(imageList: widget.imageList, movieName: widget.movieName, overview:widget.overview, vote_average:widget.vote_average,),
                        ),
                      );
                    },
                    child: Container(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 3.h),
              Text('4/9/2023', style: TextStyle(fontSize: 15.sp, fontWeight: FontWeight.w500)),

              /// =================== Time ===================
              SizedBox(height: 13.h),
              Text('TIME', style: TextStyle(color: Colors.grey, fontSize: 15.sp)),
              SizedBox(height: 3.h),
              Text('7:00', style: TextStyle(fontSize: 15.sp, fontWeight: FontWeight.w500)),

              /// =================== Seats ===================
              SizedBox(height: 13.h),
              Text('Seats', style: TextStyle(color: Colors.grey, fontSize: 15.sp)),
              SizedBox(height: 3.h),
              Text('G3,G4', style: TextStyle(fontSize: 15.sp, fontWeight: FontWeight.w500)),
            ],
          ),
        ),
