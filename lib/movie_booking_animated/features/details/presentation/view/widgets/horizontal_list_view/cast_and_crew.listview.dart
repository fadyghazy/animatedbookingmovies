      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: const [
              CastCategory(image_location: AssetsData.firstCast, image_caption: 'joe Saldana', sub_tex: "as Neyitrl"),
              CastCategory(image_location: AssetsData.secondCast, image_caption: 'Sam Worthington', sub_tex: "as Jake Sully"),
              CastCategory(image_location: AssetsData.thirdCast, image_caption: 'Sigourney Weaver', sub_tex: "as Grace"),
              CastCategory(image_location: AssetsData.forthCast, image_caption: 'Amanda Silver', sub_tex: "Writer"),
            ],
          ),
        ),
      ],
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView(
            scrollDirection: Axis.horizontal,
            children:  [
              CrewCategory(image_location: AssetsData.firstCast, image_caption: 'joe Saldana', sub_tex: "as Neyitrl"),
              CrewCategory(image_location: AssetsData.thirdCast, image_caption: 'Sigourney Weaver', sub_tex: "as Grace"),
              CrewCategory(image_location: AssetsData.forthCast, image_caption: 'Amanda Silver', sub_tex: "Writer"),
            ],
          ),
        ),
      ],
