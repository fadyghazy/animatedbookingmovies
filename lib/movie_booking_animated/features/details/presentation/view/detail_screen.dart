...
import 'package:movie_booking_animated/movie_booking_animated/features/home/presentation/view/Booking_home_screen.dart';
import '../../../../constant/strings.dart';
import '../../../booking/presentation/view/booking_screen.dart';
import 'widgets/horizontal_list_view/cast_and_crew.listview.dart';
import 'widgets/recommendedmovieconstant.dart';
...
class DetailScreen extends StatefulWidget {
  ...
  const DetailScreen({Key? key, required this.imageList, required this.movieName,required this.overview,required this.vote_average}) : super(key: key);
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(image: NetworkImage(widget.imageList), fit: BoxFit.fill),
            ),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 6.h),
                                Text(widget.overview, style: TextStyle(color: Colors.white, fontWeight: FontWeight.w400, fontSize: 15.sp)),
                              ],
                            ),
                          ),
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BookingScreen(imageList: widget.imageList, movieName: widget.movieName, vote_average: widget.vote_average, overview:widget.overview,),
                        ),
                      );
                    },
