...
const backgroundwhite=Color.fromRGBO(245, 246, 250, 1);
const gray=Color.fromRGBO(112, 112, 112, 1);
...
const newvv=LinearGradient(
  ...
  colors:[
    const Color(0xff2d2e82),
    const Color(0xff552477),

  ],
);
const textcolor=Color.fromRGBO(38, 50, 91, 1);
const double fonttitel=20;
const double fontsubtitel=14;
const double SizedBoxheight=10;
const double fonttitlelarge=40;
